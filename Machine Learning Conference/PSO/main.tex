...
\begin{frame}{Velocity Components}
    ...
    \end{itemize}
    \centering\includegraphics[width=0.9\textwidth]{lbest_vs_gbest.png}
\end{frame}
...
\begin{frame}{Geometric Interpretation-gbest}
    ...
    \end{itemize}
    \centering \includegraphics[width=0.8\textwidth]{geometric.png}
\end{frame}
...
\begin{frame}{Geometric Interpretation-lbest}
    \begin{itemize}
        ...
        \item Balance between exploration and exploitation
    \end{itemize}
    \centering \includegraphics[width=0.8\textwidth]{lbest.png}
\end{frame}
