...
\title{Redes Neuronales Artificiales: \\ Fundamentos y Aplicaciones}
\author{Prof. DSc. BARSEKH-ONJI Aboud}
\institute{{Universidad Anáhuac México}\\{Facultad de Ingeniería}}
\date{\today}
% Important to Code - Configuraciones para listings, si se usara código
\lstset{
...
\begin{frame}{Arquitectura de la Red Neuronal: Capas}
\centering
    \includegraphics[width=1.1\textwidth]{fig7.png}
\end{frame}
